...
namespace arquitectSoft
{
    public partial class FrmBuscar : Form
    {
           ...
           private void GridViewBusqueda_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            {
                case "SubComp":
                    ReturnItem1 = GridViewBusqueda.SelectedCells[0].Value.ToString();
                    ReturnItem2 = GridViewBusqueda.SelectedCells[1].Value.ToString();
                    ReturnItem3 = GridViewBusqueda.SelectedCells[2].Value.ToString();
                    break;
                default:
