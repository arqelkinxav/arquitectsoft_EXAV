...
namespace arquitectSoft.Dto
{
    class AnalisisDatosDto
    {
        ...
        public DataTable CalculateTab(int index, DataTable dtmodel, DataTable dtmodelPuerta, bool VidrioPanel, Int32 MedidaBase, decimal Desperdicio, bool swmergePM)
        {
            ...
            switch (index)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:                    
                    dt = getComponentePuertas(dtmodel, getComponentePuertasAgrupar(dtmodel, 0));
                ...
                case 7:
                    ...
                    dt = getComponentePuertas(dtmodel, getComponentePuertasAgrupar(dtmodel, 1));
                    break;
        ...
        public DataTable getComponentePuertas(DataTable dtmodelDoor, DataTable dtmodelDoorGroup)
        {
